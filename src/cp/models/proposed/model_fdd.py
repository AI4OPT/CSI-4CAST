"""
based on the model.py
- explore the denoiser's structure
    - is_post_processor: whether the denoiser includes a Conv1d post-processor
    - is_residual: whether the denoiser outputs the residual or directly the denoised signal
"""
